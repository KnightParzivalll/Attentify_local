...
import { ScheduleColumnProps } from '../schedule/ScheduleColumn.types'
import {
	scheduleColumnVariants,
	scheduleDataVariants,
	scheduleItemVariants
} from '../schedule/scheduleColumn.animations'
import ScheduleCardDashboard from './ScheduleCardDashboard' // Assuming you have ScheduleCard in its own file

// Create a motion-enabled Box.
const MotionBox = motion(Box)

interface ScheduleColumnDashboardProps extends ScheduleColumnProps {
	date: string
}

const ScheduleColumnDashboard: React.FC<ScheduleColumnDashboardProps> = ({
	label,
	date,
	isLoading,
	error,
...
export default ScheduleColumnDashboard
